...
void BluezDBus::initializeAdapter() {
    ...
    try {
        ...
        // Register for PropertiesChanged signals from BlueZ
        ...
        // Modem property changes (e.g., Powered, Online)
        std::string modemPropChangedRule = "type='signal',interface='" + CONFIG_INSTANCE()->getOfonoModemInterface() +
        "',member='PropertyChanged',sender='" + CONFIG_INSTANCE()->getOfonoServiceName() + "'";
        addMatchRule(modemPropChangedRule);
        ...
        // Voice call property changes (e.g., State)
        std::string voiceCallPropChangedRule = "type='signal',interface='" + CONFIG_INSTANCE()->getOfonoVoiceCallInterface() + 
        "',member='PropertyChanged',sender='" + CONFIG_INSTANCE()->getOfonoServiceName() + "'";
        addMatchRule(voiceCallPropChangedRule);

        // General PropertiesChanged for other oFono interfaces (Phonebook, CallHistory, etc.)
        std::string ofonoPropertiesChangedRule = "type='signal',interface='" + CONFIG_INSTANCE()->getDBusPropertiesInterface() +
        "',member='PropertiesChanged',sender='" + CONFIG_INSTANCE()->getOfonoServiceName() + "'";
        addMatchRule(ofonoPropertiesChangedRule);
